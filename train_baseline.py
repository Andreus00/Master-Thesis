...
from scene_4ddress import Scene, IsotropicGaussianModel
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        # cat = 0.5 * (image.detach().cpu().permute(1, 2, 0).numpy() + 0.5 * viewpoint_cam.original_image.cpu().detach().permute(1, 2, 0).numpy())
        # plt.imshow(cat)
        # plt.show()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[1, 500, 2_000, 30_000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[1, 500, 2_000, 30_000])
